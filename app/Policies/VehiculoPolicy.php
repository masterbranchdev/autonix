...
class VehiculoPolicy
{
    ...
    {
        return $user->can('delete_any_vehiculo');
    }
    ...
    {
        return $user->can('force_delete_any_vehiculo');
    }
    ...
    {
        return $user->can('restore_any_vehiculo');
    }
    ...
    {
        return $user->can('replicate_vehiculo');
    }
    ...
    {
        return $user->can('reorder_vehiculo');
    }
}
