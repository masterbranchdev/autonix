...
<div class="text-center px-6">
    <div class="mx-auto h-24 w-24 bg-orange-50 rounded-full flex items-center justify-center mb-6">
        <svg class="h-12 w-12 text-orange-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    <a href="{{ url('/') }}" class="inline-flex items-center gap-2 bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-8 rounded-xl transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5">
